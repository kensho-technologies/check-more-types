/*! check-more-types - v{{ include-version }}
...
return c?b.apply(null,arguments):void 0}});var o={then:f.fn};o["catch"]=f.fn;var p=l.schema.bind(null,o),q={array:Array.isArray,promise:d};[f,g,q,j,k,h,i,l].forEach(e),m.VERSION="{{ include-version }}",a.exports=m},function(a,b,c){"use strict";function d(a){return"function"==typeof a}function e(a){return"string"==typeof a}function f(a){return e(a)&&Boolean(a)}function g(a){return e(a)&&a.toUpperCase()===a}function h(a){return e(a)&&a.toLowerCase()===a}function i(a){return"object"==typeof a&&!I(a)&&!n(a)&&!q(a)}function j(a){return i(a)&&0===Object.keys(a).length}function k(a){return"number"==typeof a&&!isNaN(a)&&a!==1/0&&a!==-(1/0)}function l(a){return k(a)&&a%1===0}function m(a){return k(a)&&a%1!==0}function n(a){return null===a}function o(a){return k(a)&&a>0}function p(a){return k(a)&&0>a}function q(a){return a instanceof Date}function r(a){return a instanceof RegExp}function s(a){return a instanceof Error}function t(a,b){return a instanceof b}function u(a,b){return"number"==typeof a&&"number"!=typeof b?u(b,a):(I(a)||e(a))&&a.length===b;
